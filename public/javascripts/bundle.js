...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Recent = __webpack_require__(226);
	...
	var _MyPins = __webpack_require__(237);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/recent', component: _Recent2.default }),
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/mypins', component: _MyPins2.default, onEnter: requireAuth })
		)
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"h1",
						null,
						"Hello to PinToTheWorld!"
					),
					_react2.default.createElement(
						"p",
						null,
						"PinToTheWorld is a service for exchanging pins."
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _masonryLayout = __webpack_require__(227);
	...
	var Recent = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			var self = this;
			_superagent2.default.get('/api/getpins').end(function (err, res) {
				if (err) throw err;
		...
		eachPin: function eachPin(pin, i) {
			return _react2.default.createElement(
				'div',
				...
				_react2.default.createElement(
					'div',
					{ className: 'box' },
					_react2.default.createElement('img', { src: pin.url, alt: pin.title }),
					_react2.default.createElement(
						'h4',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Members = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			_superagent2.default.get('/api/logout').end(function (err) {
				if (err) throw err;
			});
		},
		render: function render() {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'h2',
							null,
							'You are now logged out. Thank you for using PinToTheWorld.'
						)
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = _react2.default.createClass({
		...
		changeInfo: function changeInfo(event) {
			...
			var form = {
				token: _auth2.default.getToken(),
				name: _reactDom2.default.findDOMNode(this.refs.newname).value,
				email: _reactDom2.default.findDOMNode(this.refs.newemail).value,
				username: _reactDom2.default.findDOMNode(this.refs.newusername).value
			};
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'h2',
						null,
						'Hello to your account settings.'
					),
					_react2.default.createElement(
						'h3',
						null,
						'Here you can change them.'
					)
				),
				_react2.default.createElement(
					'ul',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { ref: 'newname', type: 'text', placeholder: this.state.user.name, className: 'form-control' })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group' },
							...
							_react2.default.createElement('input', { ref: 'newemail', type: 'text', placeholder: this.state.user.email, className: 'form-control' })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group' },
							...
							_react2.default.createElement('input', { ref: 'newusername', type: 'text', placeholder: this.state.user.username, className: 'form-control' })
						),
						_react2.default.createElement('input', { name: 'submit', type: 'submit', value: 'Change Info', className: 'btn btn-default' })
					)
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { ref: 'oldpassword', type: 'password', placeholder: 'Old Password', className: 'form-control', required: true })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group' },
							...
							_react2.default.createElement('input', { ref: 'newpassword', type: 'password', placeholder: 'New Password', className: 'form-control', required: true })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group' },
							...
							_react2.default.createElement('input', { ref: 'newpassword2', type: 'password', placeholder: 'Repeat New Password', className: 'form-control', required: true })
						),
						_react2.default.createElement('input', { name: 'submit', type: 'submit', value: 'Change Password', className: 'btn btn-default' })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyPins = _react2.default.createClass({
		displayName: 'MyPins',
		getInitialState: function getInitialState() {
			return {
				pins: []
		...
		componentDidMount: function componentDidMount() {
			var self = this;
			_superagent2.default.post('/api/getmypins').send({
				token: _auth2.default.getToken()
			}).end(function (err, res) {
				if (err) throw err;
		...
		newPinCallback: function newPinCallback(title, url, isUrlValid) {
			var form = {
				title: title,
				token: _auth2.default.getToken()
			};
			if (!isUrlValid) form.url = 'http://placehold.it/200x200';else form.url = url;

			var self = this;

			_superagent2.default.post('/api/newpin').send(form).end(function (err, res) {
				if (err) throw err;

				if (res.body.success) self.setState({
					pins: res.body.pins
				});
		...
		newPin: function newPin(event) {
			event.preventDefault();
			var title = _reactDom2.default.findDOMNode(this.refs.title).value,
			    url = _reactDom2.default.findDOMNode(this.refs.url).value;

			var self = this;
			var img = new Image();
			img.onerror = function () {
				self.newPinCallback(title, url, false);
			};
			img.onload = function () {
				self.newPinCallback(title, url, true);
			};
			img.src = url;
		},
		removePin: function removePin(pin) {
			var self = this;
			_superagent2.default.post('/api/removepin').send({
				token: _auth2.default.getToken(),
				pin: pin
			}).end(function (err, res) {
				if (err) throw err;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'overlay' },
						_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove pinIcon', 'aria-hidden': 'true', onClick: this.removePin.bind(null, pin) })
					)
				)
			);
		},
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'form',
							{ onSubmit: this.newPin, id: 'newPinForm' },
							_react2.default.createElement(
								'div',
								{ className: 'form-group' },
								_react2.default.createElement(
								...
								_react2.default.createElement('input', { ref: 'title', type: 'text', className: 'form-control', placeholder: 'Enter pin title' })
							),
							_react2.default.createElement(
								'div',
								{ className: 'form-group' },
								...
								_react2.default.createElement('input', { ref: 'url', type: 'text', className: 'form-control', placeholder: 'Enter pin url' })
							),
				...
				this.state.pins.length === 0 ? _react2.default.createElement(
					'p',
					{ className: 'alert alert-info' },
					'You currently do not have any pin.'
				) : null,
				this.state.pins.length !== 0 ? _react2.default.createElement(
					'p',
					null,
